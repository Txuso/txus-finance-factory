                ...
                <CardContent className="p-3 sm:p-4">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="p-1.5 sm:p-2 bg-white/20 rounded-xl backdrop-blur-md">
                            {isPositive ? <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 text-white" /> : <TrendingDown className="h-4 w-4 sm:h-5 sm:w-5 text-white" />}
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md bg-white dark:bg-slate-900 transition-all hover:scale-105 active:scale-95 cursor-pointer">
                <CardContent className="p-3 sm:p-4">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="p-1.5 sm:p-2 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                ...
                <CardContent className="p-3 sm:p-4">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-lg sm:text-xl font-bold mt-1 text-rose-600 dark:text-rose-400">
                                {formatCurrency(totalExpenses)}
                            </h3>
                        </div>
                        <div className="p-1.5 sm:p-2 bg-rose-50 dark:bg-rose-900/20 rounded-xl">
                ...
                <CardContent className="p-3 sm:p-4">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-lg sm:text-xl font-bold mt-1 text-blue-600 dark:text-blue-400">
                                {formatCurrency(totalInvestments)}
                            </h3>
                        </div>
                        <div className="p-1.5 sm:p-2 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
