...
const getTypeStyles = (type: string) => {
    switch (type) {
        case 'salary': return "bg-blue-500/10 border-blue-500/20 text-blue-700 dark:text-blue-300 shadow-blue-500/5";
        case 'alert': return "bg-rose-500/10 border-rose-500/20 text-rose-700 dark:text-rose-300 shadow-rose-500/5";
        case 'success': return "bg-emerald-500/10 border-emerald-500/20 text-emerald-700 dark:text-emerald-300 shadow-emerald-500/5";
        case 'tip': return "bg-amber-500/10 border-amber-500/20 text-amber-700 dark:text-amber-300 shadow-amber-500/5";
        default: return "bg-slate-500/10 border-slate-500/20 text-slate-700 dark:text-slate-300 shadow-slate-500/5";
    }
};
                ...
                {insights.map((insight, idx) => (
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between mb-3 relative z-10">
                            <div className={cn("p-2.5 rounded-2xl shadow-sm transition-transform group-hover:rotate-6", getIconContainerStyles(insight.type))}>
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xs font-medium leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">{insight.message}</p>
                        </div>
                    </div>
                ))}
            </div>
